...
struct SwapArenaCoresetReducer
{    
...
static_assert(CoresetReducer<SwapArenaCoresetReducer<0U, std::mt19937>>, "SwapArenaCoresetReducer does not satisfy CoresetReducer concept");
