...
#include "streamkm/reducer/swap/precomp_sqnorms_cached.hpp"
...
namespace streamkm {
    ...
    using SwapTPcSqNormsCachedCoresetReducer = _SwapPcSqNormsCachedCoresetReducer<CoresetReducerNoMetrics, TreeCoresetClusterSet>;
    using SwapFPcSqNormsCachedCoresetReducer = _SwapPcSqNormsCachedCoresetReducer<CoresetReducerNoMetrics, FenwickCoresetClusterSet>;
    ...
    using SwapTPcSqNormsCachedCoresetReducerWMetrics = _SwapPcSqNormsCachedCoresetReducer<CoresetReducerChronoMetrics, TreeCoresetClusterSet>;
    using SwapFPcSqNormsCachedCoresetReducerWMetrics = _SwapPcSqNormsCachedCoresetReducer<CoresetReducerChronoMetrics, FenwickCoresetClusterSet>;
}