...
struct _IndexCachedCoresetReducer
{    
...
static_assert(CoresetReducer<_IndexCachedCoresetReducer<CoresetReducerNoMetrics, FenwickCoresetClusterSet>>, "IndexCachedCoresetReducer does not satisfy CoresetReducer concept");
